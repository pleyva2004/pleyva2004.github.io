  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 pt-20 relative">
      <div className="text-center max-w-2xl mx-auto">
        ...
        >
          <blockquote className="text-gray-800 text-sm sm:text-base font-display tracking-wide leading-relaxed">
            {text}
          ...
          {!isChatExpanded && (
            <Magnetic>
              <motion.div
                ...
                className="bg-dark-card backdrop-blur-xl rounded-xl px-6 py-4 shadow-xl cursor-pointer hover:bg-white/10 transition-all duration-200 group border border-white/10"
              ...
              >
                <div className="flex items-center justify-between space-x-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-white/90 text-sm sm:text-base group-hover:text-white transition-colors font-display tracking-tight">
                      Ask me about Pablo
                    </span>
                  </div>
