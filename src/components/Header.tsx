...
const Header: React.FC = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-dark-card border-b border-dark-border/50">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <div>
              <h1 className="text-base font-bold text-white leading-tight font-display tracking-tight">Pablo Leyva</h1>
